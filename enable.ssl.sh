#!/bin/bash
certbot certonly --webroot -w /var/apps/acme -d jincor.com -d www.jincor.com -d ico.jincor.com -d api.jincor.com -m tech@jincor.com -n --agree-tos

rm /etc/nginx/sites-available/api.jincor.com.conf
rm /etc/nginx/sites-available/ico.jincor.com.conf
...
ln -s /etc/nginx/ssl/ico.jincor.com.ssl.conf /etc/nginx/sites-available/ico.jincor.com.ssl.conf
